...
class BotManager extends Singleton implements \ArrayAccess, \Countable {
    ...
    public function Initialise($aBotList) {
        ...
        if(function_exists('pcntl_signal_dispatch')) {
            pcntl_signal(SIGTERM, [$this, 'onCatchSignal']);
            pcntl_signal(SIGINT, [$this, 'onCatchSignal']);
            pcntl_signal(SIGTERM, [$this, 'onCatchSignal']);
     ...
     */
    public function create($sName, $sNetwork, $aChannels = []) {
        $pBot = new Bot ($sName);
    ...
    public function onCatchSignal($nSignal) {
        ...
        echo 'Nuwani has been shutdown..' . PHP_EOL;
        die ();
    }
